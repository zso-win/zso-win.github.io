...
`,[y("absolute",`
 ...
 `,[We({background:"var(--n-color-modal)"}),y("hoverable",[p("&:hover","box-shadow: var(--n-box-shadow);")]),y("content-segmented",[p(">",[m("content",{paddingTop:"var(--n-padding-bottom)"})])]),y("content-soft-segmented",[p(">",[m("content",`
