import{i as $e,p as qe,c as L,o as Pe,a as Se,d as M,b as Ye,h as u,T as ke,e as Ue,f as m,g as Te,j as U,k as d,u as ze,t as He,r as N,n as Xe,l as ae,m as _e,q as Be,s as P,v as J,w as le,x as Je,y as Fe,z as Ze,A as We,B as ge,C as eo,D as l,E as te,F as oo,G as Ie,H as ro,I as to,J as X,K as se,L as Y,M as ne,N as A,O as ve,P as me,Q as fe,R as no,S as io,U as pe,V as so}from"./index-5b34432c.js";import{N as ao}from"./Image-6e9288c3.js";function ye(e){return e.replace(/#|\(|\)|,|\s/g,"_")}const Ce=Se("n-form-item");function lo(e,{defaultSize:r="medium",mergedSize:n,mergedDisabled:a}={}){const i=$e(Ce,null);qe(Ce,null);const c=L(n?()=>n(i):()=>{const{size:f}=e;if(f)return f;if(i){const{mergedSize:z}=i;if(z.value!==void 0)return z.value}return r}),v=L(a?()=>a(i):()=>{const{disabled:f}=e;return f!==void 0?f:i?i.disabled.value:!1}),t=L(()=>{const{status:f}=e;return f||(i==null?void 0:i.mergedValidationStatus.value)});return Pe(()=>{i&&i.restoreValidation()}),{mergedSizeRef:c,mergedDisabledRef:v,mergedStatusRef:t,nTriggerFormBlur(){i&&i.handleContentBlur()},nTriggerFormChange(){i&&i.handleContentChange()},nTriggerFormFocus(){i&&i.handleContentFocus()},nTriggerFormInput(){i&&i.handleContentInput()}}}const Ee=M({name:"BaseIconSwitchTransition",setup(e,{slots:r}){const n=Ye();return()=>u(ke,{name:"icon-switch-transition",appear:n.value},r)}}),co=M({name:"FadeInExpandTransition",props:{appear:Boolean,group:Boolean,mode:String,onLeave:Function,onAfterLeave:Function,onAfterEnter:Function,width:Boolean,reverse:Boolean},setup(e,{slots:r}){function n(t){e.width?t.style.maxWidth=`${t.offsetWidth}px`:t.style.maxHeight=`${t.offsetHeight}px`,t.offsetWidth}function a(t){e.width?t.style.maxWidth="0":t.style.maxHeight="0",t.offsetWidth;const{onLeave:f}=e;f&&f()}function i(t){e.width?t.style.maxWidth="":t.style.maxHeight="";const{onAfterLeave:f}=e;f&&f()}function c(t){if(t.style.transition="none",e.width){const f=t.offsetWidth;t.style.maxWidth="0",t.offsetWidth,t.style.transition="",t.style.maxWidth=`${f}px`}else if(e.reverse)t.style.maxHeight=`${t.offsetHeight}px`,t.offsetHeight,t.style.transition="",t.style.maxHeight="0";else{const f=t.offsetHeight;t.style.maxHeight="0",t.offsetWidth,t.style.transition="",t.style.maxHeight=`${f}px`}t.offsetWidth}function v(t){var f;e.width?t.style.maxWidth="":e.reverse||(t.style.maxHeight=""),(f=e.onAfterEnter)===null||f===void 0||f.call(e)}return()=>{const{group:t,width:f,appear:z,mode:Q}=e,k=t?Ue:ke,K={name:f?"fade-in-width-expand-transition":"fade-in-height-expand-transition",appear:z,onEnter:c,onAfterEnter:v,onBeforeLeave:n,onLeave:a,onAfterLeave:i};return t||(K.mode=Q),u(k,K,r)}}}),{cubicBezierEaseInOut:uo}=Te;function he({originalTransform:e="",left:r=0,top:n=0,transition:a=`all .3s ${uo} !important`}={}){return[m("&.icon-switch-transition-enter-from, &.icon-switch-transition-leave-to",{transform:e+" scale(0.75)",left:r,top:n,opacity:0}),m("&.icon-switch-transition-enter-to, &.icon-switch-transition-leave-from",{transform:`scale(1) ${e}`,left:r,top:n,opacity:1}),m("&.icon-switch-transition-enter-active, &.icon-switch-transition-leave-active",{transformOrigin:"center",position:"absolute",left:r,top:n,transition:a})]}const fo=m([m("@keyframes loading-container-rotate",`
 to {
...
`),go=M({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(e){ze("-base-wave",xo,He(e,"clsPrefix"));const r=N(null),n=N(!1);let a=null;return Pe(()=>{a!==null&&window.clearTimeout(a)}),{active:n,selfRef:r,play(){a!==null&&(window.clearTimeout(a),n.value=!1,a=null),Xe(()=>{var i;(i=r.value)===null||i===void 0||i.offsetHeight,n.value=!0,a=window.setTimeout(()=>{n.value=!1,a=null},1e3)})}}},render(){const{clsPrefix:e}=this;return u("div",{ref:"selfRef","aria-hidden":!0,class:[`${e}-base-wave`,this.active&&`${e}-base-wave--active`]})}}),{cubicBezierEaseInOut:O}=Te;function vo({duration:e=".2s",delay:r=".1s"}={}){return[m("&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to",{opacity:1}),m("&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from",`
 opacity: 0!important;
 ...
 align-items: center;
 justify-content: center;
 `,[he({top:"50%",originalTransform:"translateY(-50%)"})]),vo()]),d("content",`
 display: flex;
 align-items: center;
 flex-wrap: nowrap;
 min-width: 0;
...
`,[J("vertical",`
 ...
 width: 100%;
 margin: 0;
 `),J("dashed",[d("line",{backgroundColor:"var(--n-color)"})]),P("dashed",[d("line",{borderColor:"var(--n-color)"})]),P("vertical",{backgroundColor:"var(--n-color)"})]),Fo=Object.assign(Object.assign({},le.props),{titlePlacement:{type:String,default:"center"},dashed:Boolean,vertical:Boolean}),Wo=M({name:"Divider",props:Fo,setup(e){const{mergedClsPrefixRef:r,inlineThemeDisabled:n}=Fe(e),a=le("Divider","-divider",Bo,_o,e,r),i=L(()=>{const{common:{cubicBezierEaseInOut:v},self:{color:t,textColor:f,fontWeight:z}}=a.value;return{"--n-bezier":v,"--n-color":t,"--n-text-color":f,"--n-font-weight":z}}),c=n?We("divider",void 0,i,e):void 0;return{mergedClsPrefix:r,cssVars:n?void 0:i,themeClass:c==null?void 0:c.themeClass,onRender:c==null?void 0:c.onRender}},render(){var e;const{$slots:r,titlePlacement:n,vertical:a,dashed:i,cssVars:c,mergedClsPrefix:v}=this;return(e=this.onRender)===null||e===void 0||e.call(this),u("div",{role:"separator",class:[`${v}-divider`,this.themeClass,{[`${v}-divider--vertical`]:a,[`${v}-divider--no-title`]:!r.default,[`${v}-divider--dashed`]:i,[`${v}-divider--title-position-${n}`]:r.default&&n}],style:c},a?null:u("div",{class:`${v}-divider__line ${v}-divider__line--left`}),!a&&r.default?u(Ie,null,u("div",{class:`${v}-divider__title`},this.$slots),u("div",{class:`${v}-divider__line ${v}-divider__line--right`})):null)}}),Io={key:0},Eo=M({__name:"TheQuiz",setup(e){const r=N(""),n=ro(),a=N([{text:"September"},{text:"Oktober"},{text:"November",isCorrectAnswer:!0},{text:"Dezember"}]),i=N("Wann findet die nächste Ausgabe der Wintimäss statt?");function c(t){t.isCorrectAnswer?(console.log("Correct Answer"),r.value="Das ist richtig!",n.update({answer1:!0})):(console.log("Wrong Answer"),r.value="Leider falsch.",n.answers.answer1=!1)}function v(){n.update({answer1:!1,answer2:!1})}return to(()=>{}),(t,f)=>(X(),se("div",null,[Y(A(ve),{justify:"center"},{default:ne(()=>[Y(A(ao),{width:"320",src:"src/assets/ambulance.jpg"})]),_:1}),me("div",null,fe(i.value),1),A(n).answers.answer1?io("",!0):(X(),se("div",Io,[Y(A(ve),{vertical:""},{default:ne(()=>[(X(!0),se(Ie,null,no(a.value,z=>(X(),so(A(we),{block:"",key:z.text,onClick:Q=>c(z)},{default:ne(()=>[pe(fe(z.text),1)]),_:2},1032,["onClick"]))),128))]),_:1})])),me("p",null,fe(r.value),1),Y(A(Wo)),Y(A(we),{block:"",onClick:v},{default:ne(()=>[pe("Reset")]),_:1})]))}});const Go=M({__name:"QuizView",setup(e){return(r,n)=>(X(),se("main",null,[Y(Eo)]))}});export{Go as default};
