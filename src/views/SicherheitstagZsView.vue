        ...
        <div class="content">
            ...
            <div v-if="isCorrect">
                <p class="text">
                    ...
                    Natürlich nicht! Im Zivilschutz können nicht nur Männer mitmachen,
                    die zum Schutzdienst gesetzlich verpflichtet sind, sondern auch Frauen.
                    Ebenso können sich Männer sogenannt «über Alter» für den  
                    <a href="https://www.zh.ch/de/sicherheit-justiz/zivilschutz/dienst-im-zivilschutz.html" target="_blank">freiwilligen Schutzdienst</a>
                    melden.
                </p>
            </div>
            <div v-if="isWrong">
